...
use App\Http\Controllers\Admin\addfaqController;
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => 'auth'], function() {
 ...
 // Add Faq
 Route::post('/faqs/tabledata', [addfaqController::class, 'tabledata'])->name('admin.faqs.tabledata');
 Route::get('/faqs/add-new-faq', [addfaqController::class, 'create'])->name('admin.faqs.create');
 Route::get('/faqs/update-faq/{id}', [addfaqController::class, 'edit'])->name('admin.faqs.edit');
 Route::post('/faqs/store', [addfaqController::class, 'store'])->name('admin.faqs.store');
 Route::post('/faqs/update-faq/{id}', [addfaqController::class, 'update'])->name('admin.faqs.update');
 Route::delete('/faqs/delete/{id}', [addfaqController::class, 'destroy'])->name('admin.faqs.destroy');
 Route::get('/faqs', [addfaqController::class, 'index'])->name('admin.faqs.index');


    //contact
    Route::post('/contact/tabledata', [contactController::class, 'tabledata'])->name('admin.contact.tabledata');
    Route::get('/contact/add-new-contact', [contactController::class, 'create'])->name('admin.contact.create');
    Route::get('/contact/update-contact/{id}', [contactController::class, 'edit'])->name('admin.contact.edit');
    Route::post('/contact/store', [contactController::class, 'store'])->name('admin.contact.store');
    Route::post('/contact/update-contact/{id}', [contactController::class, 'update'])->name('admin.contact.update');
    Route::delete('/contact/delete/{id}', [contactController::class, 'destroy'])->name('admin.contact.destroy');
    Route::get('/contact', [contactController::class, 'index'])->name('admin.contact.index');
//insurance
    Route::post('/insurance/tabledata', [insuranceController::class, 'tabledata'])->name('admin.insurance.tabledata');
    ...
    Route::post('/insurance/store', [insuranceController::class, 'store'])->name('admin.insurance.store');
    ...
    Route::get('/insurance', [insuranceController::class, 'index'])->name('admin.insurance.index');
        ...
        // about
        Route::post('/about/tabledata', [AboutController::class, 'tabledata'])->name('admin.about.tabledata');
        Route::get('/about/add-new-about', [AboutController::class, 'create'])->name('admin.about.create');
        Route::get('/about/update-about/{id}', [AboutController::class, 'edit'])->name('admin.about.edit');
        Route::post('/about/store', [AboutController::class, 'store'])->name('admin.about.store');
        Route::post('/about/update-about/{id}', [AboutController::class, 'update'])->name('admin.about.update');
        Route::delete('/about/delete/{id}', [AboutController::class, 'destroy'])->name('admin.about.destroy');
        Route::get('/about', [AboutController::class, 'index'])->name('admin.about.index');
        Route::get('/about-front', [AboutController::class, 'fpage'])->name('admin.about.front');
...
// Route::get('/insurance/{id}',[homecontroller::class,'insu'])->name('insurance');
Route::get('insurance/{id}', [homeController::class, 'insu'])->name('insurance');
