...
<ul>
    ...
    <li><a class="{{ $pageName == 'Page' || $pageName == 'Add Page' || $pageName == 'Update Page' || $pageName == 'Section' || $pageName == 'Add Section' || $pageName == 'Update Section' || $pageName == 'Faq' || $pageName == 'Add Faq' || $pageName == 'Update Faq' || $pageName == 'Gallery' || $pageName == 'Add Gallery' || $pageName == 'Update Gallery' || $pageName == 'Testimonial' || $pageName == 'Add Testimonial' || $pageName == 'Update Testimonial' || $pageName == 'Update Testimonial'? 'active' : '' }}" href="javascript:;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
        ...
        <!-- sub-menu -->
        <ul class="sub-menu">
            <li><a class="{{ $pageName == 'Page'? 'active' : '' }}" href="{{ route('admin.page.index') }}">Home</a> </li>
            <li><a class="{{ $pageName == 'about'? 'active' : '' }}" href="{{ route('admin.about.front') }}">About</a> </li>
            <li><a class="{{ $pageName == 'faq'? 'active' : '' }}" href="{{ route('admin.faq.index') }}">Faq's</a> </li>
            <li><a class="{{ $pageName == 'contact'? 'active' : '' }}" href="{{ route('admin.contact.index') }}">contact</a> </li>
            <li><a class="{{ $pageName == 'insurance'? 'active' : '' }}" href="{{ route('admin.insurance.index') }}">insurance</a> </li>
            <li><a class="{{ $pageName == 'add faqs'? 'active' : '' }}" href="{{ route('admin.faqs.index') }}">Add faq</a> </li>


            {{-- <ul class="sub-men">
                <li><a class="{{ $pageName == ''? 'active' : '' }}" href="{{ route('admin.page.index') }}">Home</a>
            <li><a class="{{ $pageName == ''? 'active' : '' }}" href="{{ route('admin.page.index') }}">About</a>
                <li><a class="{{ $pageName == ''? 'active' : '' }}" href="{{ route('admin.page.index') }}">Life Insurance</a>
                    <li><a class="{{ $pageName == ''? 'active' : '' }}" href="{{ route('admin.page.index') }}">Faq</a>
