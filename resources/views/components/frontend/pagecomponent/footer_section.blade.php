                ...
                <div class="row">
                    <div class="col-md-4 mb-md-0 mb-4">
                        ...
                        <ul class="ftco-footer-social p-0">
                            <li class="ftco-animate text-center"><a href="#" data-toggle="tooltip"
                                    data-placement="top" title="Twitter"><i style="font-size: 35px;margin-top:3px;"
                                        class="fa-brands fa-twitter"></i></a>
                            </li>
                            <li class="ftco-animate text-center"><a href="#" data-toggle="tooltip"
                                    data-placement="top" title="Facebook"><i style="font-size: 35px;margin-top:3px;"
                                        class="fa-brands fa-facebook"></i></a></li>
                            <li class="ftco-animate text-center"><a href="#" data-toggle="tooltip"
                                    data-placement="top" title="Instagram"><i style="font-size: 35px;margin-top:3px;"
